...
#define FASTENC_AVC_IOC_GET_DEVINFO 				_IOW(FASTENC_AVC_IOC_MAGIC, 0xf0, unsigned int)
...
extern AMVEnc_Status FastEncodeSlice(void *dev, unsigned char* outptr,int* datalen, bool re_encode);
